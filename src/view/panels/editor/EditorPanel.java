...
import view.components.ludemenode.block.LudemeConnectionComponent;
import view.components.ludemenode.LudemeConnection;
import view.components.ludemenode.interfaces.LudemeNodeComponent;
...
public class EditorPanel extends JPanel implements IGraphPanel {
    ...
    @Override
    public view.components.ludemenodecomponent.LudemeNodeComponent getNodeComponent(LudemeNode node) {
        return null;
    }

    @Override
    public void addNode(Ludeme ludeme, int x, int y, boolean connect) {
        addLudemeNode(ludeme, new Point(x,y), connect);
    }
